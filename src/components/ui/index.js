...
import UFieldCode from "@/components/ui/UFieldCode";
import UFieldRadio from "@/components/ui/UFieldRadio";
...
export default [
    ...
    { name: 'UCard', component: UCard },
    { name: 'UField', component: UField },
    { name: 'UFieldCode', component: UFieldCode },
    { name: 'UFieldRadio', component: UFieldRadio },
